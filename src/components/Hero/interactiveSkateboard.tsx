      ...
      >
        <Suspense>
          <Scene
            ...
            truckColorURL={props.truckColorURL}
            wheelTextureURL={props.wheelTextureURL}
            boltColorURL={props.boltColorURL}
          />
        </Suspense>
      </Canvas>
    </div>
      ...
      <group ref={originRef}>
        <group ref={containerRef} position={[-0.25, 0, -0.635]}>
          <group position={[0, -0.086, 0.635]}>
            <Skateboard
              wheelTextureURLs={[props.wheelTextureURL]}
              wheelTextureURL={props.wheelTextureURL}
              deckTextureURLs={[props.deckTextureURL]}
              deckTextureURL={props.deckTextureURL}
              truckColor={props.truckColorURL}
              boltColor={props.boltColorURL}
              constantWheelSpin
            />
